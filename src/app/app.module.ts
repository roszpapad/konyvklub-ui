...
@NgModule({
  ...
  entryComponents: [NewBookDialogComponent,NewOfferDialogComponent,NewTicketDialogComponent, UpdateOfferDialogComponent, UpdateTicketDialogComponent, UpdateUserDialogComponent]
})
